...
\texttt{paper/scripts/check-bib.mjs -{}-online} repeats the registry check; on 2026-09-25 all 67 DOIs resolved and every registered title matched. The four entries without a DOI (\src{visquill}, \src{slingsby2018tilemaps}, \src{openshaw1984maup}, \src{cartocrow}) were checked by loading their URLs.
...
\src{wallinger2026clarity} & F pre & $n=54$; straight leaders faster, similar accuracy & $n$ from arXiv v1; the version-of-record abstract confirms the result \\
...
\src{cartocrow} & W & C++ framework containing necklace-map algorithms & project page, 2026-09-25; it names no paper for the framework \\
