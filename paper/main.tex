...
\title{Lenses That Summarise: Bearing-Faithful Aggregating Map Lenses,\\
...
\input{sections/04-descriptive}
\input{sections/05-generative}
...
\appendix
\onecolumn
\input{sections/A-citation-audit}
